            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
                {step === 1 ? (
                    <>
                        ...
                        <p className="text-center text-gray-500 dark:text-gray-400 mb-6">Responde tus preguntas de seguridad.</p>
                        <form onSubmit={handleVerifyAnswers} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative mt-1">
                                    ...
                                    <button type="button" onClick={() => setShowAnswer2(!showAnswer2)} className="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500" aria-label={showAnswer2 ? 'Ocultar código' : 'Mostrar código'}>
                    ...
                    <>
                        ...
                        <p className="text-center text-gray-500 dark:text-gray-400 mb-6">Tus respuestas fueron correctas. Ingresa tu nuevo PIN.</p>
                        <form onSubmit={handleResetPin} className="space-y-4">
                             <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button type="button" onClick={() => setShowNewPin(!showNewPin)} className="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500" aria-label={showNewPin ? 'Ocultar PIN' : 'Mostrar PIN'}>
