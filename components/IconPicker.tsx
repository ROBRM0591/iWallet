...
export const IconPicker: React.FC<IconPickerProps> = ({ onSelect, onClose, currentColor }) => {
    ...
    return (
        <div 
          className="absolute z-20 mt-2 w-72 origin-top-right rounded-xl bg-white dark:bg-gray-800 shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none"
                ...
                <div className="grid grid-cols-5 gap-3">
                    {Object.entries(PREDEFINED_ICONS).map(([key, { icon: Icon, name }]) => (
                        <button
                            ...
                            className="flex items-center justify-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
                        >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center p-2 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition"
                    >
                ...
                <div className="grid grid-cols-8 gap-2">
                    {COLORS.map(color => (
                        <button
                            ...
                            className={`w-6 h-6 rounded-full border-2 dark:border-gray-600 transition-all ${selectedColor === color ? 'ring-2 ring-offset-2 ring-primary-500 dark:ring-offset-gray-800' : 'ring-0'}`}
                        >
